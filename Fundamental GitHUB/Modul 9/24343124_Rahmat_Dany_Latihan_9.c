...
int main() {
    ...
    FILE *inputFile = fopen("D:\\Tugas Kuliah\\Matkul Fundamental\\Visual Studio Code\\Program-Fundamental\\input.txt", "r");
    if (inputFile == NULL) {
    ...
    FILE *outputFile = fopen("D:\\Tugas Kuliah\\Matkul Fundamental\\Visual Studio Code\\Program-Fundamental\\output.txt", "w");
    if (outputFile == NULL) {
