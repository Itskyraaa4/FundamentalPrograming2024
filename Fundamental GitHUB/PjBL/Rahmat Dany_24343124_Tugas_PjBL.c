/*
	Nama File		: Projectfunda.c
	Programmer		: Rahmat Dany (24343124)
	Tgl. pembuatan	: 11 Desember 2024
...
void biodata() {
   printf("\tPengelompokan nilai siswa\n");
    printf("============================================\n");
...
int main() {
    ...
    do {
        ...
        if (pilihan == 1) {
            ...
            // Membuka file input
            inputFile = fopen("D:\\Tugas Kuliah\\Matkul Fundamental\\Fundamental\\Project\\input_3.txt", "r");
            if (inputFile == NULL) {
            ...
            // Membuka file output
            outputFile = fopen("D:\\Tugas Kuliah\\Matkul Fundamental\\Fundamental\\Project\\output_3.txt", "w");
            if (outputFile == NULL) {
